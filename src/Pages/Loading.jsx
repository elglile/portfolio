...
const Loading = () => {
  const { MylogoG, careerFocus } = MyInfo[0];

  return (
    <div className="w-[100%] h-screen bg-gray-200 flex items-center flex-col justify-center space-y-2 z-50">
      <svg
        height="90"
        viewBox="0 0 196 313"
        fill=""
      ...
      >
        ...
        <defs>
          <linearGradient id="ttb" y2="1">
            ...
            <stop offset="100%" stopOpacity="1" stopColor="#0077B6">
              <animate
      ...
      <div className="text-white text-lg  flex space-x-4 ">
        {careerFocus.map((focus, index) => (
          <h2
            key={index}
            className={`${
              index % 2 === 0 ? "text-gray-800" : "text-Tird_Color"
            }`}
          >
            {focus}
          </h2>
